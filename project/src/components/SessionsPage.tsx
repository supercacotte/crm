                ...
                <div onClick={() => setSelectedSession(session)} className="cursor-pointer">
                  <SummaryBanner
                    ...
                    data={{
                      ...
                      sessionType: typeLabels[session.type],
                      status: session.status,
                      assignedCoach: 'Coach assigné' // À adapter selon vos données
                    }}
                  />
                </div>
            ...
            {upcomingSessions.map((session) => (
              <div key={session.id} className="bg-blue-50 rounded-lg p-3 border border-blue-100">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs text-blue-600 font-medium">{typeLabels[session.type]}</span>
                </div>
            ...
            <div className="mt-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="text-sm text-gray-600 space-y-2">
                  ...
                  <div>
                    <strong>Type:</strong> {typeLabels[selectedSession.type]}
                  </div>
                  <div>
      ...
      {sessionForInvoice && (
        <CreateInvoiceModal
          ...
          sessions={[{
            ...
            status: 'completed',
            description: `Séance ${typeLabels[sessionForInvoice.type]} - ${sessionForInvoice.duration}min`
          }]}
